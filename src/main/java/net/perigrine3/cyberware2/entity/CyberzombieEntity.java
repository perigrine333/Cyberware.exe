...
package net.perigrine3.cyberware2.entity;

import net.perigrine3.cyberware2.entity.renderer.CyberzombieRenderer;
...
public class CyberzombieEntity extends Cyberware2ModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("cyberzombie").setRegistryName("cyberzombie");
	public CyberzombieEntity(Cyberware2ModElements instance) {
		super(instance, 122);
		FMLJavaModLoadingContext.get().getModEventBus().register(new CyberzombieRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16737895, -3407872, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("cyberzombie_spawn_egg"));
	}
