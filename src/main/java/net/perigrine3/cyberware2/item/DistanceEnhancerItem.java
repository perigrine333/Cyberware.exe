...
public class DistanceEnhancerItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:distance_enhancer")
	public static final Item block = null;
	public DistanceEnhancerItem(Cyberware2ModElements instance) {
		super(instance, 79);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("distance_enhancer");
		}
