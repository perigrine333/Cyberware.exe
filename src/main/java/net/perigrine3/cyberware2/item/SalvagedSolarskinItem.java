...
public class SalvagedSolarskinItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:salvaged_solarskin")
	public static final Item block = null;
	public SalvagedSolarskinItem(Cyberware2ModElements instance) {
		super(instance, 50);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("salvaged_solarskin");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Produce energy when in the sun"));
			list.add(new StringTextComponent("Produces +4pow/s when in use"));
