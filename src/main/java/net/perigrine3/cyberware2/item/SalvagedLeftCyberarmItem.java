...
public class SalvagedLeftCyberarmItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:salvaged_left_cyberarm")
	public static final Item block = null;
	public SalvagedLeftCyberarmItem(Cyberware2ModElements instance) {
		super(instance, 62);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("salvaged_left_cyberarm");
		}
