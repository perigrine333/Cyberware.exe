...
public class QuickdrawFlywheelsItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:quickdraw_flywheels")
	public static final Item block = null;
	public QuickdrawFlywheelsItem(Cyberware2ModElements instance) {
		super(instance, 109);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("quickdraw_flywheels");
		}
