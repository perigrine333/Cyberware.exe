...
public class SalvagedLiverFilterItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:salvaged_liver_filter")
	public static final Item block = null;
	public SalvagedLiverFilterItem(Cyberware2ModElements instance) {
		super(instance, 46);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("salvaged_liver_filter");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("No negative effects from food and drink"));
