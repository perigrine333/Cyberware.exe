...
public class SalvagedUltradenseCapacitorItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:salvaged_ultradense_capacitor")
	public static final Item block = null;
	public SalvagedUltradenseCapacitorItem(Cyberware2ModElements instance) {
		super(instance, 45);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("salvaged_ultradense_capacitor");
		}
