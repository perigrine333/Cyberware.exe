...
public class SalvagedNeuralContextualizerItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:salvaged_neural_contextualizer")
	public static final Item block = null;
	public SalvagedNeuralContextualizerItem(Cyberware2ModElements instance) {
		super(instance, 36);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("salvaged_neural_contextualizer");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Automatically switch to the right tool"));
