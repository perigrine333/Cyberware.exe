...
public class LinearActuatorsItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:linear_actuators")
	public static final Item block = null;
	public LinearActuatorsItem(Cyberware2ModElements instance) {
		super(instance, 115);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("linear_actuators");
		}
