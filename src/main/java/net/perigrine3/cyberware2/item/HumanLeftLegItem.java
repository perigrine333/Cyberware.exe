...
public class HumanLeftLegItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:human_left_leg")
	public static final Item block = null;
	public HumanLeftLegItem(Cyberware2ModElements instance) {
		super(instance, 12);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("human_left_leg");
		}
