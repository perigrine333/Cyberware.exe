...
public class ComponentSyntheticNervesItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:component_synthetic_nerves")
	public static final Item block = null;
	public ComponentSyntheticNervesItem(Cyberware2ModElements instance) {
		super(instance, 24);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("component_synthetic_nerves");
		}
