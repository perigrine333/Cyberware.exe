...
public class HumanMuscleTissueItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:human_muscle_tissue")
	public static final Item block = null;
	public HumanMuscleTissueItem(Cyberware2ModElements instance) {
		super(instance, 9);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("human_muscle_tissue");
		}
