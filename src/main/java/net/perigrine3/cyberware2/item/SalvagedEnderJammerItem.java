...
public class SalvagedEnderJammerItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:salvaged_ender_jammer")
	public static final Item block = null;
	public SalvagedEnderJammerItem(Cyberware2ModElements instance) {
		super(instance, 34);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("salvaged_ender_jammer");
		}
