...
public class SalvagedRetractableClawsItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:salvaged_retractable_claws")
	public static final Item block = null;
	public SalvagedRetractableClawsItem(Cyberware2ModElements instance) {
		super(instance, 65);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("salvaged_retractable_claws");
		}
