...
public class DeployableWheelsItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:deployable_wheels")
	public static final Item block = null;
	public DeployableWheelsItem(Cyberware2ModElements instance) {
		super(instance, 121);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("deployable_wheels");
		}
