...
public class SalvagedCompressedOxygenImplantItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:salvaged_compressed_oxygen_implant")
	public static final Item block = null;
	public SalvagedCompressedOxygenImplantItem(Cyberware2ModElements instance) {
		super(instance, 43);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("salvaged_compressed_oxygen_implant");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Additional oxygen that regenerates slowly"));
