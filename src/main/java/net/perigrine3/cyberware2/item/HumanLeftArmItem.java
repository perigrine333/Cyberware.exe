...
public class HumanLeftArmItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:human_left_arm")
	public static final Item block = null;
	public HumanLeftArmItem(Cyberware2ModElements instance) {
		super(instance, 10);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("human_left_arm");
		}
