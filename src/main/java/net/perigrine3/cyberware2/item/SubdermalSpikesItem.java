...
public class SubdermalSpikesItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:subdermal_spikes")
	public static final Item block = null;
	public SubdermalSpikesItem(Cyberware2ModElements instance) {
		super(instance, 99);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("subdermal_spikes");
		}
