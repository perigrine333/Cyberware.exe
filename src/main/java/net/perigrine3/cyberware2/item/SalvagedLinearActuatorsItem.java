...
public class SalvagedLinearActuatorsItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:salvaged_linear_actuators")
	public static final Item block = null;
	public SalvagedLinearActuatorsItem(Cyberware2ModElements instance) {
		super(instance, 67);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("salvaged_linear_actuators");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Jump higher"));
			list.add(new StringTextComponent("Shift jump to launch yourself"));
