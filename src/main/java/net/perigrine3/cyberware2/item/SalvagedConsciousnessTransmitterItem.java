...
public class SalvagedConsciousnessTransmitterItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:salvaged_consciousness_transmitter")
	public static final Item block = null;
	public SalvagedConsciousnessTransmitterItem(Cyberware2ModElements instance) {
		super(instance, 35);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("salvaged_consciousness_transmitter");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Keep some XP after death"));
