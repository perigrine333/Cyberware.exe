...
public class PlateletDispatcherItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:platelet_dispatcher")
	public static final Item block = null;
	public PlateletDispatcherItem(Cyberware2ModElements instance) {
		super(instance, 88);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("platelet_dispatcher");
		}
