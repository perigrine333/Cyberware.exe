...
public class CorticalStackItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:cortical_stack")
	public static final Item block = null;
	public CorticalStackItem(Cyberware2ModElements instance) {
		super(instance, 81);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("cortical_stack");
		}
