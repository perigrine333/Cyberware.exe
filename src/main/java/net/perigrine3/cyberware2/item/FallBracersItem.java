...
public class FallBracersItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:fall_bracers")
	public static final Item block = null;
	public FallBracersItem(Cyberware2ModElements instance) {
		super(instance, 116);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Absorb impacts"));
