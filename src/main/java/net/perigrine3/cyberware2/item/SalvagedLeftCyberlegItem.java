...
public class SalvagedLeftCyberlegItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:salvaged_left_cyberleg")
	public static final Item block = null;
	public SalvagedLeftCyberlegItem(Cyberware2ModElements instance) {
		super(instance, 69);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("salvaged_left_cyberleg");
		}
