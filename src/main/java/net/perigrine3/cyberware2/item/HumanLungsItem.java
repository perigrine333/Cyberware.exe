...
public class HumanLungsItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:human_lungs")
	public static final Item block = null;
	public HumanLungsItem(Cyberware2ModElements instance) {
		super(instance, 3);
	}
