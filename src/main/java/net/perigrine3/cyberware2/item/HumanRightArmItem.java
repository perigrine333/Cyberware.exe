...
public class HumanRightArmItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:human_right_arm")
	public static final Item block = null;
	public HumanRightArmItem(Cyberware2ModElements instance) {
		super(instance, 11);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("human_right_arm");
		}
