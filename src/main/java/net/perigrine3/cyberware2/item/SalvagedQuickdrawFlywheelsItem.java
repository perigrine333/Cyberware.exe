...
public class SalvagedQuickdrawFlywheelsItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:salvaged_quickdraw_flywheels")
	public static final Item block = null;
	public SalvagedQuickdrawFlywheelsItem(Cyberware2ModElements instance) {
		super(instance, 61);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("salvaged_quickdraw_flywheels");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Draw bows and crossbows faster"));
