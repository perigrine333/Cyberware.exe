...
public class HumanEyeballsItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:human_eyeballs")
	public static final Item block = null;
	public HumanEyeballsItem(Cyberware2ModElements instance) {
		super(instance, 2);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("human_eyeballs");
		}
