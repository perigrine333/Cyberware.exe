...
public class ComponentActuatorItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:component_actuator")
	public static final Item block = null;
	public ComponentActuatorItem(Cyberware2ModElements instance) {
		super(instance, 16);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("component_actuator");
		}
