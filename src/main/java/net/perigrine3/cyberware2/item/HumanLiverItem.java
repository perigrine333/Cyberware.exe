...
public class HumanLiverItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:human_liver")
	public static final Item block = null;
	public HumanLiverItem(Cyberware2ModElements instance) {
		super(instance, 4);
	}
