...
public class SyntheticSkinItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:synthetic_skin")
	public static final Item block = null;
	public SyntheticSkinItem(Cyberware2ModElements instance) {
		super(instance, 100);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("synthetic_skin");
		}
