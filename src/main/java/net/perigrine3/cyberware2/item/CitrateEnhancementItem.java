...
public class CitrateEnhancementItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:citrate_enhancement")
	public static final Item block = null;
	public CitrateEnhancementItem(Cyberware2ModElements instance) {
		super(instance, 107);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("citrate_enhancement");
		}
