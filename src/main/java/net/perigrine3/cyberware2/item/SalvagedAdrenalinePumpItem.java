...
public class SalvagedAdrenalinePumpItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:salvaged_adrenaline_pump")
	public static final Item block = null;
	public SalvagedAdrenalinePumpItem(Cyberware2ModElements instance) {
		super(instance, 49);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("salvaged_adrenaline_pump");
		}
