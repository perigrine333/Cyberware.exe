...
public class SalvagedRightCyberarmItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:salvaged_right_cyberarm")
	public static final Item block = null;
	public SalvagedRightCyberarmItem(Cyberware2ModElements instance) {
		super(instance, 63);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("salvaged_right_cyberarm");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Enables Cyberarm upgrades"));
