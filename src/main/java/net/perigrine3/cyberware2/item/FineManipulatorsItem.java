...
public class FineManipulatorsItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:fine_manipulators")
	public static final Item block = null;
	public FineManipulatorsItem(Cyberware2ModElements instance) {
		super(instance, 112);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("fine_manipulators");
		}
