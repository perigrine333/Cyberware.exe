...
public class SolarskinItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:solarskin")
	public static final Item block = null;
	public SolarskinItem(Cyberware2ModElements instance) {
		super(instance, 98);
	}
