...
public class RightCyberarmItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:right_cyberarm")
	public static final Item block = null;
	public RightCyberarmItem(Cyberware2ModElements instance) {
		super(instance, 111);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("right_cyberarm");
		}
