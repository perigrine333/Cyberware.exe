...
public class ComponentFullereneMicrostructuresItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:component_fullerene_microstructures")
	public static final Item block = null;
	public ComponentFullereneMicrostructuresItem(Cyberware2ModElements instance) {
		super(instance, 18);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("component_fullerene_microstructures");
		}
