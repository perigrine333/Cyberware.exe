...
public class CardiomechanicPumpItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:cardiomechanic_pump")
	public static final Item block = null;
	public CardiomechanicPumpItem(Cyberware2ModElements instance) {
		super(instance, 86);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("cardiomechanic_pump");
		}
