...
public class HumanHeartItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:human_heart")
	public static final Item block = null;
	public HumanHeartItem(Cyberware2ModElements instance) {
		super(instance, 5);
	}
