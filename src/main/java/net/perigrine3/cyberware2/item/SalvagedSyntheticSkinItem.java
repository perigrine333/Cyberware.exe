...
public class SalvagedSyntheticSkinItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:salvaged_synthetic_skin")
	public static final Item block = null;
	public SalvagedSyntheticSkinItem(Cyberware2ModElements instance) {
		super(instance, 52);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("salvaged_synthetic_skin");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Hide Cyberlimbs"));
		}
	}
}
