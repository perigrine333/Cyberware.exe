...
public class SalvagedPlateletDispatcherItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:salvaged_platelet_dispatcher")
	public static final Item block = null;
	public SalvagedPlateletDispatcherItem(Cyberware2ModElements instance) {
		super(instance, 40);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("salvaged_platelet_dispatcher");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Heals when close to full health"));
