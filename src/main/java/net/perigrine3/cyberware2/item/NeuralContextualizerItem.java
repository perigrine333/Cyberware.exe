...
public class NeuralContextualizerItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:neural_contextualizer")
	public static final Item block = null;
	public NeuralContextualizerItem(Cyberware2ModElements instance) {
		super(instance, 84);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("neural_contextualizer");
		}
