...
public class ComponentBioreactorItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:component_bioreactor")
	public static final Item block = null;
	public ComponentBioreactorItem(Cyberware2ModElements instance) {
		super(instance, 21);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("component_bioreactor");
		}
