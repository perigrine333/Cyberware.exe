...
public class SalvagedReinforcedFistItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:salvaged_reinforced_fist")
	public static final Item block = null;
	public SalvagedReinforcedFistItem(Cyberware2ModElements instance) {
		super(instance, 66);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("salvaged_reinforced_fist");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Hands mine at stone level"));
