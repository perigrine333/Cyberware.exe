...
public class MetabolicGeneratorItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:metabolic_generator")
	public static final Item block = null;
	public MetabolicGeneratorItem(Cyberware2ModElements instance) {
		super(instance, 95);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("metabolic_generator");
		}
