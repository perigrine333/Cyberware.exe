...
public class SalvagedCitrateEnhancementItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:salvaged_citrate_enhancement")
	public static final Item block = null;
	public SalvagedCitrateEnhancementItem(Cyberware2ModElements instance) {
		super(instance, 59);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("salvaged_citrate_enhancement");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Resilience to fall damage"));
