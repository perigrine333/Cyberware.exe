...
public class CybereyesItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:cybereyes")
	public static final Item block = null;
	public CybereyesItem(Cyberware2ModElements instance) {
		super(instance, 74);
	}
