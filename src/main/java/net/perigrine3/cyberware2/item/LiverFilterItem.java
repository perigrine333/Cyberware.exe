...
public class LiverFilterItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:liver_filter")
	public static final Item block = null;
	public LiverFilterItem(Cyberware2ModElements instance) {
		super(instance, 94);
	}
