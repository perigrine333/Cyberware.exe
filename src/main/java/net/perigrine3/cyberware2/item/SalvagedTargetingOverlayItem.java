...
public class SalvagedTargetingOverlayItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:salvaged_targeting_overlay")
	public static final Item block = null;
	public SalvagedTargetingOverlayItem(Cyberware2ModElements instance) {
		super(instance, 30);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("salvaged_targeting_overlay");
		}
