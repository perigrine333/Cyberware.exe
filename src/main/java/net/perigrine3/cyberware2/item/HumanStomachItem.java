...
public class HumanStomachItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:human_stomach")
	public static final Item block = null;
	public HumanStomachItem(Cyberware2ModElements instance) {
		super(instance, 6);
	}
