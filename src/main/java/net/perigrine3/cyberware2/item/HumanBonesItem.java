...
public class HumanBonesItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:human_bones")
	public static final Item block = null;
	public HumanBonesItem(Cyberware2ModElements instance) {
		super(instance, 7);
	}
