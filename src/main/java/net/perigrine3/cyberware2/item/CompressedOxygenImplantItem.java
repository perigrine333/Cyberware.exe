...
public class CompressedOxygenImplantItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:compressed_oxygen_implant")
	public static final Item block = null;
	public CompressedOxygenImplantItem(Cyberware2ModElements instance) {
		super(instance, 91);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("compressed_oxygen_implant");
		}
