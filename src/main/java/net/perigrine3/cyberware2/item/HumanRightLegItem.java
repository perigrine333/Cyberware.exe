...
public class HumanRightLegItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:human_right_leg")
	public static final Item block = null;
	public HumanRightLegItem(Cyberware2ModElements instance) {
		super(instance, 13);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("human_right_leg");
		}
