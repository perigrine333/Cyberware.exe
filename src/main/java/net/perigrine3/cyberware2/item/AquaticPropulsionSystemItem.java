...
public class AquaticPropulsionSystemItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:aquatic_propulsion_system")
	public static final Item block = null;
	public AquaticPropulsionSystemItem(Cyberware2ModElements instance) {
		super(instance, 120);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("aquatic_propulsion_system");
		}
