...
public class SalvagedImplantedSpursItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:salvaged_implanted_spurs")
	public static final Item block = null;
	public SalvagedImplantedSpursItem(Cyberware2ModElements instance) {
		super(instance, 71);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("salvaged_implanted_spurs");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Speed up horses"));
