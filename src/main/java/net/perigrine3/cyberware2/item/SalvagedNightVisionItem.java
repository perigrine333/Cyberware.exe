...
public class SalvagedNightVisionItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:salvaged_night_vision")
	public static final Item block = null;
	public SalvagedNightVisionItem(Cyberware2ModElements instance) {
		super(instance, 27);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("salvaged_night_vision");
		}
