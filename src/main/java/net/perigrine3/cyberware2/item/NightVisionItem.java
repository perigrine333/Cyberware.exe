...
public class NightVisionItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:night_vision")
	public static final Item block = null;
	public NightVisionItem(Cyberware2ModElements instance) {
		super(instance, 75);
	}
