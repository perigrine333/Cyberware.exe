...
public class LeftCyberarmItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:left_cyberarm")
	public static final Item block = null;
	public LeftCyberarmItem(Cyberware2ModElements instance) {
		super(instance, 110);
	}
