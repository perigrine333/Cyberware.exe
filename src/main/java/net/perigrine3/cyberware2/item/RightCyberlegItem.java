...
public class RightCyberlegItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:right_cyberleg")
	public static final Item block = null;
	public RightCyberlegItem(Cyberware2ModElements instance) {
		super(instance, 118);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("right_cyberleg");
		}
