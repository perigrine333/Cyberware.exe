...
public class SalvagedCorticalStackItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:salvaged_cortical_stack")
	public static final Item block = null;
	public SalvagedCorticalStackItem(Cyberware2ModElements instance) {
		super(instance, 33);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("salvaged_cortical_stack");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Saves XP in a capsule after death"));
