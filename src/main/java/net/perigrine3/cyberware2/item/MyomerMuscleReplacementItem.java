...
public class MyomerMuscleReplacementItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:myomer_muscle_replacement")
	public static final Item block = null;
	public MyomerMuscleReplacementItem(Cyberware2ModElements instance) {
		super(instance, 105);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("myomer_muscle_replacement");
		}
