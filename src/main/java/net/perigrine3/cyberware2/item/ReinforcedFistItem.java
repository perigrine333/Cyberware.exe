...
public class ReinforcedFistItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:reinforced_fist")
	public static final Item block = null;
	public ReinforcedFistItem(Cyberware2ModElements instance) {
		super(instance, 114);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("reinforced_fist");
		}
