...
public class BonelacingItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:bonelacing")
	public static final Item block = null;
	public BonelacingItem(Cyberware2ModElements instance) {
		super(instance, 106);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Tolerance Cost: 3\\6\\9\\12\\15"));
		}
	}
}
