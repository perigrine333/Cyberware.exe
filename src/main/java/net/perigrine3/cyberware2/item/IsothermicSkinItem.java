...
public class IsothermicSkinItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:isothermic_skin")
	public static final Item block = null;
	public IsothermicSkinItem(Cyberware2ModElements instance) {
		super(instance, 102);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("isothermic_skin");
		}
