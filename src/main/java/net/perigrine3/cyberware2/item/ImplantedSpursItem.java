...
public class ImplantedSpursItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:implanted_spurs")
	public static final Item block = null;
	public ImplantedSpursItem(Cyberware2ModElements instance) {
		super(instance, 119);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("implanted_spurs");
		}
