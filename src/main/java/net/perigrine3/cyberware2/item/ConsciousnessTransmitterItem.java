...
public class ConsciousnessTransmitterItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:consciousness_transmitter")
	public static final Item block = null;
	public ConsciousnessTransmitterItem(Cyberware2ModElements instance) {
		super(instance, 83);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("consciousness_transmitter");
		}
