...
public class StemCellSynthesizerItem extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:stem_cell_synthesizer")
	public static final Item block = null;
	public StemCellSynthesizerItem(Cyberware2ModElements instance) {
		super(instance, 89);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("stem_cell_synthesizer");
		}
