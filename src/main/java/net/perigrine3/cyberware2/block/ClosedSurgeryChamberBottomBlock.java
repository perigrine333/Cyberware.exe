...
import net.perigrine3.cyberware2.procedures.ClosedSurgeryChamberRightCloickedProcedure;
...
public class ClosedSurgeryChamberBottomBlock extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:closed_surgery_chamber_bottom")
	public static final Block block = null;
	public ClosedSurgeryChamberBottomBlock(Cyberware2ModElements instance) {
		super(instance, 137);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("closed_surgery_chamber_bottom");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ClosedSurgeryChamberRightCloickedProcedure.executeProcedure($_dependencies);
			}
