...
public class DeconstructionTableBlock extends Cyberware2ModElements.ModElement {
	@ObjectHolder("cyberware2:deconstruction_table")
	public static final Block block = null;
	public DeconstructionTableBlock(Cyberware2ModElements instance) {
		super(instance, 192);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("deconstruction_table");
		}
